...
function scoreSetlistCandidate(concert, item, { role = "support", isFestival = false, targetArtist = "" } = {}) {  const concertArtist = normalizeLoose(itemSafeArtist(targetArtist || concert?.main_artist));
